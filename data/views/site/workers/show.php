<h1>Подразделение: <?= htmlspecialchars($department->name ?? 'Все подразделения') ?></h1>
...
<a href="<?= app()->route->getUrl('/departments/' . $department->id . '/attach') ?>" class="btn btn-success">Прикрепить сотрудника</a>
<a href="<?= app()->route->getUrl('/departments') ?>" class="btn">Назад к списку</a>
...
<table style="margin-top: 1rem;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?= floor((time() - strtotime($worker->birthday)) / 31556926) ?></td>
